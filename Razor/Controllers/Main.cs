...
namespace Stockboy.Controllers {
	...
	public class MainController : BaseController {
		...
		[Route ("/")]
		public async Task<IActionResult> home () => View ("Home", new TableModel () { list = await Stocks.GetHoldings (context) });


		[Route ("/Dividends")]
		public async Task<IActionResult> dividends () {

			List<DividendsModel>? dividends = Stocks.GetDividendsView (context)?.Export<List<DividendsModel>> ();
		...
		public IActionResult purchases () {
			List<TransactionsView>? purchase_list = Stocks.GetTransactionsView (context);
		...
		[Route ("/Tickers")]
		public IActionResult tickers () => View ("Tickers", new TableModel () { list = Stocks.GetTickersView (context) });

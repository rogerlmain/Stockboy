...
export default class TickerSelector extends Component<TickerSelectorProps, TickerSelectorState> {
	...
	public render () {
		return <div className="column-centered somewhat-spaced-out row-block">
			...
			<BrokerList selected_item={this.props.broker_id} allow_all={this.props.allow_all} header="Select Broker"
			...
			<TickerList selected_item={this.props.ticker_id} allow_all={this.props.allow_all} header="Select Ticker"
				onChange={(event: ChangeEvent<HTMLSelectElement>) => {

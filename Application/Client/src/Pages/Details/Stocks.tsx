...
export default class StockDetailsPage extends Component<Object, StockDetailsPageState> {
	...
	public render () {
		return <div>
			...
			<Optional condition={not_empty (this.state.stock_details)}>
				<div className="column-block with-lotsa-headspace">
